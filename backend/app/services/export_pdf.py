...
def render_business_case_pdf(data) -> bytes:
    ...
    kpis = [
        ("Operative Kosten", _fmt_optional_money(data.kpis.get("operative_cost_total"))),
        ("Gebundenes Projektkapital", _fmt_optional_money(data.kpis.get("bound_capital_total"))),
        ("CAPEX gesamt", _fmt_optional_money(data.kpis.get("capex_cost_total"))),
        ...
        ("ROI Bottom Price inkl. CAPEX %", _pct_str(data.kpis.get("roi_incl_capex_bottom_pct"))),
        ("ROI tatsächlich inkl. CAPEX %", _pct_str(data.kpis.get("roi_incl_capex_actual_pct"))),
        ("Operativer ROI Bottom Price %", _pct_str(data.kpis.get("roi_operating_bottom_pct"))),
        ("Operativer ROI tatsächlich %", _pct_str(data.kpis.get("roi_operating_actual_pct"))),
